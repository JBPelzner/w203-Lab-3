...
In summary, the key explanatory variables in our baseline model will be probability of arrest and density. The next figure shows the marginal distributions of both key explanatory variables and of crime rate.
